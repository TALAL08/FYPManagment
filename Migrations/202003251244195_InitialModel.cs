namespace FYPManagment.Migrations
{
    ...
    public partial class InitialModel : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        RecevierId = c.String(maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Groups", t => t.GroupId, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.RecevierId)
                .ForeignKey("dbo.AspNetUsers", t => t.SenderId)
                .Index(t => t.GroupId)
                .Index(t => t.SenderId)
                .Index(t => t.RecevierId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Documents", "SenderId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Documents", "RecevierId", "dbo.AspNetUsers");
            ...
            DropIndex("dbo.Documents", new[] { "RecevierId" });
